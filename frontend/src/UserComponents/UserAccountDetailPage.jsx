...
<div className="detailsofUserAccount">
  <div style={{display:"flex" , flexDirection:"row" }}> <div style={{fontWeight:"bold" , fontSize:"20px"}}>Full Name: </div> <div style={{fontSize:"20px"}}>&nbsp;&nbsp;{userData.fullName}</div> </div>
  <hr />
  <div style={{display:"flex" , flexDirection:"row" }}> <div style={{fontWeight:"bold" , fontSize:"20px"}}>Username: </div> <div style={{fontSize:"20px" }}>&nbsp;&nbsp;{userData.username}</div> </div>
  <hr />
  <div style={{display:"flex" , flexDirection:"row" }}> <div style={{fontWeight:"bold" , fontSize:"20px" }}>Email: </div> <div style={{fontSize:"20px" }}>&nbsp;&nbsp;{userData.email}</div> </div>
  <hr />
